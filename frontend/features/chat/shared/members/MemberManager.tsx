...
interface MembersManagerProps {
  contacts?: Member[];
  onSelectMember?: (contact: Member) => void;
  onAddMember?: () => void;
  onCallMember?: (contact: Member) => void;
  onMessageMember?: (contact: Member) => void;
}
...
export function MembersManager({ 
  ...
  const filteredMembers = contacts.filter(contact =>
        ...
        {filteredMembers.length === 0 ? (
          ...
          filteredMembers.map((contact) => (
            <div
              ...
              onClick={() => onSelectMember?.(contact)}
            >
              <Avatar>
