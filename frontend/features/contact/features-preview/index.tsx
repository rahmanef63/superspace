 ...
 * 
 * Mock preview showing Contacts/connections interface
 */
      ...
      <div className="flex -space-x-2">
        ...
        {data.Contacts.length > 4 && (
          <div className="h-8 w-8 rounded-full bg-muted border-2 border-background flex items-center justify-center">
            <span className="text-xs">+{data.Contacts.length - 4}</span>
          </div>
        )}
      </div>
    )
    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-2">
        <div className="relative flex-1">
          ...
          <Input placeholder="Find Contacts..." className="pl-9 h-9" disabled={!interactive} />
        </div>
            ...
            <ScrollArea className="h-[200px]">
              <div className="divide-y">
                {data.Contacts.map((Contact) => (
                  <div key={Contact.id} className="flex items-center gap-3 p-3 hover:bg-muted/50 transition-colors">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-muted-foreground">
                        {Contact.mutualWorkspaces} shared workspaces
                      </p>
                    </div>
  ...
  mockDataSets: [
    {
      id: 'default',
      name: 'My Network',
      description: 'Your Contact connections',
      data: {
