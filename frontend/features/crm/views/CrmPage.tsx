...
export default function CrmPage({ workspaceId }: CrmPageProps) {
  ...
  // Get real stats from the hook
  const { stats: customerStats } = useCrmCustomers(workspaceId as Id<"workspaces"> | undefined)

  const stats = {
    totalContacts: customerStats.total,
    totalLeads: customerStats.leads,
    openOpportunities: 0,
    pipelineValue: 0,
    conversionRate: 0,
    activeCampaigns: 0,
