...
export const DEFAULT_PAGE_MANIFEST: PageManifestItem[] = [
  {
    ...
    icon: Home,
    component: lazy(() => import("@/frontend/shared/views/dynamic/overview/page")),
  },
  {
    id: "chats",
    ...
    icon: MessageCircle,
    component: lazy(() => import("@/frontend/features/chat/backUp_page")),
  },
  {
    id: "calls",
  ...
  },
  {
    ...
    icon: Archive,
    component: lazy(() => import("@/frontend/features/chat/archived/page")),
  },
  {
    id: "profile",
    ...
    icon: User,
    component: lazy(() => import("@/frontend/shared/views/static/profile/page")),
  },
  {
    id: "members",
    ...
    icon: Users,
    component: lazy(() => import("@/frontend/shared/views/static/member/page")),
  },
  {
    id: "friends",
    ...
    icon: Heart,
    component: lazy(() => import("@/frontend/shared/views/static/friends/page")),
  },
  {
    id: "pages",
    ...
    icon: FileText,
    component: lazy(() => import("@/frontend/shared/views/static/pages/page")),
  },
  {
    id: "databases",
    ...
    icon: Database,
    component: lazy(() => import("@/frontend/shared/views/static/databases/page")),
  },
  {
    id: "canvas",
  ...
  },
  {
    ...
    icon: Menu,
    component: lazy(() => import("@/frontend/shared/views/static/menus/page")),
  },
  {
    id: "invitations",
    ...
    icon: Mail,
    component: lazy(() => import("@/frontend/shared/views/static/invitations/page")),
  },
  {
    id: "user-settings",
    componentId: "ProfilePage",
  ...
  },
  {
    ...
    icon: Settings,
    component: lazy(() => import("@/frontend/shared/views/static/workspaces/page")),
  },
  {
    id: "calendar",
